...
/****** Object:  StoredProcedure [dbo].[usp_PandLSummary_TwelveMonths_CorporateExpense_Detail]    Script Date: 24/11/2016 10:54:23 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_PandLSummary_TwelveMonths_CorporateExpense_Detail]
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pTemplate int,
	@pLanguage int,
...
, PandLCorporateExpenseCTE (TemplateID,OrgSkey, GroupID ,GroupDesc,
...
SELECT			
		...
		LEFT OUTER JOIN(
						...
						WHERE [IsNetRevenues] = 'Y')NRCTE
							ON Template.OrgSkey = NRCTE.OrgSkey --on PCTE.GroupId in (106,95,108,96) = NRCTE.GroupId
		...
		GROUP BY GROUPID
					...
					,GroupDesc 
					,OrgSkey
	) GALYPL ON Template.TemplateID = GALYPL.TemplateID
														AND Template.GroupID = GALYPL.GroupId
														AND Template.OrgSkey = GALYPL.OrgSkey
