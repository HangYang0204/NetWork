...
/****** Object:  StoredProcedure [dbo].[usp_ProfitandLossSummaryFact_12MonthsData]    Script Date: 24/11/2016 11:06:03 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_ProfitandLossSummaryFact_12MonthsData]
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pTemplate int,
	@pLanguage int,
...
----		
		...
		GROUP BY GROUPID
					...
					,GroupDesc
													...
													AND Template.Group1level = GTLYPL.Group1level
													AND Template.Group2level = GTLYPL.Group2level
													AND Template.Group3level = GTLYPL.Group3level
