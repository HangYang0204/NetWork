...
/****** Object:  StoredProcedure [dbo].[usp_ProfitandLossSummaryFact_BudgetBU_Detail]    Script Date: 24/11/2016 11:06:27 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_ProfitandLossSummaryFact_BudgetBU_Detail] 
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pTemplate int,
	@pLanguage int,
...
FROM        FactProfitAndLossSummary   AS PL 
		...
		LEFT OUTER JOIN [dbo].[FactGLBudgetingProcess] FB ON PL.[PostPeriodSkey] = FB.[PostPeriodSkey] --Add Budget Amt
