...
/****** Object:  StoredProcedure [dbo].[usp_ProfitandLossSummaryFact_BudgetCorporateExpenseDraft_Detail]    Script Date: 24/11/2016 11:08:02 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_ProfitandLossSummaryFact_BudgetCorporateExpenseDraft_Detail] 
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pTemplate int,
	@pLanguage int,
...
OrgSkey, -- To Add PY year
OrganizationID,[Organization Name],
TemplateID, GroupID ,GroupDesc, 
AccountID, AccountDesc, --added
/*2*/
...
( 
	SELECT   
						 CYPL.OrgSkey
						,CYPL.OrganizationID ,CYPL.OrganizationID + ' - ' + CYPL.[OrganizationDesc] as [Organization Name]
						,CYPL.TemplateID,CYPL.GroupID, CYPL.GroupDesc
						,CYPL.AccountID, CYPL.AccountDesc  --added
						,[HeaderLine],[ShowDetail],[InsertSkipLineBefore],[SkipLine]
						,[IsMarkup]	,[IsNetRevenues],[IsDirectLabor],[IsFringeBenefitsPct],[IsFringeBenefits]
						,[IsManagementSalaries]	,[IsMarketingSalaries],[IsTrainingSalaries],[IsEBGEPct],[IsEBGE]
						,[IsEBREPct],[IsEBRE],[IsEBITDAPct],[IsEBITDA],[IsCalculatedUtilizationPct]		
