...
/****** Object:  StoredProcedure [dbo].[usp_ProfitandLossSummaryFact_Detail]    Script Date: 24/11/2016 11:08:47 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_ProfitandLossSummaryFact_Detail] 
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pTemplate int,
	@pLanguage int,
			...
			( 
				SELECT  
						...
						, ISNULL(Case @pCurrency  WHEN @ConsCurrency THEN SUM(PL.ConsCMAmt * FT.IncomeStatementActualSign) 
										   ...
										   Else 0.000000
						  END,0.00000) as [Current Month Amount]
