...
/****** Object:  StoredProcedure [dbo].[usp_ProfitandLossSummaryFact_OrgComparison]    Script Date: 24/11/2016 11:10:03 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_ProfitandLossSummaryFact_OrgComparison] 
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pTemplate int,
	@pLanguage int,
...
BEGIN
		...
		WITH ProfitandLossCTE (TemplateID, Group1Level,Group2Level,Group3Level, Group1LevelID, Group2LevelID, Group3LevelID, GroupID ,GroupDesc,[HeaderLine],[ShowDetail],[InsertSkipLineBefore],[SkipLine]
...
-----		
		...
		WHERE        (PL.PostPeriodSkey = @pFiscalPeriod) 
					...
					--AND HeaderLine = 'Y'
					--AND GroupID NOT IN (94,95,96,100,106,108) Handel on VS
		...
		GROUP BY	 FT.TemplateID
			  ...
			  (		SELECT Group1Level,Group2Level,Group3Level,Group1LevelID, Group2LevelID, Group3LevelID,Templ.*
						...
						--AND GroupID  IN (94,95,96,100,106,108)
						)Templ
