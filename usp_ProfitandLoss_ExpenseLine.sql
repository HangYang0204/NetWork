...
/****** Object:  StoredProcedure [dbo].[usp_ProfitandLoss_ExpenseLine]    Script Date: 24/11/2016 11:00:32 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE Procedure [dbo].[usp_ProfitandLoss_ExpenseLine] 
	@pCurrency varchar(5),
	@pFiscalPeriod int,
	@pLanguage int,
	@pOrg varchar(max),
...
SET @pInOrg = @pOrg
Set @pTemplate = 101;
SET @GroupID = '-29, -30, -31, -32, -33, -34, -454, -455'
